...
public class HojaSubrogacionController {
	...
	public CompletableFuture<Object> consultarFolioOrden(@RequestBody DatosRequest request,
	...
	public CompletableFuture<Object> consultarProveedor(@RequestBody DatosRequest request,
			Authentication authentication) throws IOException, SQLException {
	...
	public CompletableFuture<?> buscarFiltros(@RequestBody DatosRequest request, Authentication authentication)
	...
	public CompletableFuture<?> buscarDetalle(@RequestBody DatosRequest request, Authentication authentication)
			throws IOException, ParseException {
		Response<Object> response = hojaSubrogacionService.busquedaDetalle(request, authentication);
		return CompletableFuture
				.supplyAsync(() -> new ResponseEntity<>(response, HttpStatus.valueOf(response.getCodigo())));
	}
	...
	public CompletableFuture<?> buscarServicios(@RequestBody DatosRequest request, Authentication authentication)
			throws IOException, ParseException {
	...
	public CompletableFuture<?> generarHojaSubrogacion(@RequestBody DatosRequest request, Authentication authentication)
			throws IOException, ParseException {
	...
	public CompletableFuture<Object> insertaHoja(@RequestBody DatosRequest request, Authentication authentication)
			throws Exception {
	...
	public CompletableFuture<Object> modificaHoja(@RequestBody DatosRequest request, Authentication authentication)
			throws IOException {
	...
	public CompletableFuture<Object> generarReporteHojaSubrogacion(@RequestBody DatosRequest request,
	...
	CompletableFuture<Object> fallbackGenerico(@RequestBody DatosRequest request, Authentication authentication,
		...
		logUtil.crearArchivoLog(Level.INFO.toString(), this.getClass().getSimpleName(),
				this.getClass().getPackage().toString(), RESILENCIA, CONSULTA, authentication);
		return CompletableFuture
				.supplyAsync(() -> new ResponseEntity<>(response, HttpStatus.valueOf(response.getCodigo())));
	}
